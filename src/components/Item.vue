    ...
    <div class="mediaItem__wrapper pb-4">
        <router-link :to="{ name: 'ItemDetail', params: {media_type: this.mediaItem.media_type, id: this.mediaItem.id} }">
            <div class="poster pb-3">
                <img :src="getApiConf.images.base_url + getApiConf.images.poster_sizes[1] + (mediaItem.poster_path || mediaItem.profile_path)" :title="mediaItem.release_date || mediaItem.first_air_date">
